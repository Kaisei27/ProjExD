...
def main():
    ...
    #壁の追加
    kabe = pygame.image.load("fig/kabe.jpg").convert_alpha()  
    kabe2 = pygame.image.load("fig/kabe2.jpg").convert_alpha()    
    rect_kabe = kabe.get_rect()
    rect_kabe2 = kabe2.get_rect()
    rect_kabe.center = (330,120) 
    rect_kabe2.center = (330,360)
    ...
    pygame.draw.circle(circ_sur,(255,0,255),(ball_r, ball_r), ball_r)
    ball = circ_sur
    ...
    while (1):
        ...
        pygame.draw.ellipse(screen,(255,255,255),(280,180,100,100),5) #中央にサークルの描画
        ...
        screen.blit(kabe, rect_kabe)
        screen.blit(kabe2,rect_kabe2)
